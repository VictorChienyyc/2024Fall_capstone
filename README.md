...
## How to implement
Most of the code is from this video and Github. To run the original author's project easily, you can open the tcl file in the vivado and it will configure all the thing automatically.
...
*Figure 1: Verification flow chart - PC*
